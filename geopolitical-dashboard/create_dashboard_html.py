"""
Create a multi-page HTML dashboard that links all charts
"""
...
{nav_items}                </ul>
    ...
    <div class="container-fluid">
        ...
        <div class="chart-container">
            <iframe src="{chart["file"]}" title="{chart["name"]}"></iframe>
        </div>
    </div>
...
if __name__ == '__main__':
    print("=" * 70)
    print("CREATING MULTI-PAGE HTML DASHBOARD")
    print("=" * 70)
    print()
    ...
    print("  - chart0.html through chart5.html (individual charts)")
